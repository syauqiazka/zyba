...
export default function ChatHeader({
  ...
  return (
    <header className="px-6 py-3.5 border-b border-brown-900/10 flex items-center justify-between bg-white/95 sticky top-0 z-10">
      ...
      {/* Right: Mood Chip + Action Icons */}
      <div className="flex items-center gap-2">
        {/* Dynamic Emotion Chip from Latest Analysis (10.1) */}
        <span
          className={`rounded-pill ${moodColor} text-white text-[11px] font-semibold px-3 py-1 shadow-sm flex items-center gap-1`}
