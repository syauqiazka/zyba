...
const SLIDES = [
  {
    ...
    emoji: "🌱",
    tag: "Pengenalan ZYBA",
    bg: "from-orange-100/60 to-cream",
  },
  {
    ...
    <div className="flex flex-col gap-8 pb-12">
      ...
      <div className="w-full max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 border border-brown-900/10 shadow-lg flex flex-col items-center text-center gap-6 relative overflow-hidden">
          ...
          {SLIDES.map((_, i) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all duration-300 ${
                i === currentSlide ? "w-8 bg-brown-900" : "w-2.5 bg-brown-900/20 hover:bg-brown-900/40"
              }`}
        ...
        <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/community"
            className="text-xs font-bold text-brown-900 hover:underline"
          >
            Jelajahi Komunitas →
          </Link>
        </div>
