...
const NAV_ITEMS = [
  ...
  { href: "/onboarding", label: "Welcome / Onboarding", icon: "user" },
];
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-brown-900/10 bg-white/70 backdrop-blur-md min-h-screen p-6 flex flex-col justify-between sticky top-0 h-screen z-30">
      ...
      <div className="flex flex-col gap-3 pt-4 border-t border-brown-900/10">
        ...
        <Link
          href="/settings"
          className="flex items-center gap-3 p-2 rounded-2xl hover:bg-green-100/50 transition-colors"
        >
          <div className="w-8 h-8 rounded-full bg-green-500 text-white font-display font-bold flex items-center justify-center text-xs shadow-sm">
            AL
          </div>
          <div className="flex flex-col flex-1 min-w-0">
            <span className="text-xs font-bold text-brown-900 truncate">Alex Rivera</span>
            <span className="text-[10px] text-brown-700 truncate">alex@zyba.app</span>
          </div>
          <svg className="w-4 h-4 text-brown-700 opacity-60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
